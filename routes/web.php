...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::group(['middleware' => ['permission:category list']], function () {
        ...
        Route::get('store_index_data', [StoreCategoryController::class, 'index_data'])->name('store_category.index_data');
        Route::post('store-category-bulk-action', [StoreCategoryController::class, 'bulk_action'])->name('store_category.bulk-action');
        Route::post('store-category-action', [StoreCategoryController::class, 'action'])->name('store_category.action');
        //storeSubcategory
        Route::resource('store-subcategory', StoreSubCategoryController::class);
        Route::get('store_category_index_data', [StoreSubCategoryController::class, 'index_data'])->name('store_subcategory.index_data');
        Route::post('store-subcategory-bulk-action', [StoreSubCategoryController::class, 'bulk_action'])->name('store_subcategory.bulk-action');
        Route::post('store-subcategory-action', [StoreSubCategoryController::class, 'action'])->name('store_subcategory.action');
    });
