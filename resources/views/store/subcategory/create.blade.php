    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($subcategory,['method' => 'POST','route'=>'store-subcategory.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'subcategory'] ) }}
                            {{ Form::hidden('id') }}
                            <div class="row">
