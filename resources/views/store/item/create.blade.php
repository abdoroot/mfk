<x-master-layout>
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="{{ route('store-item.index') }}" class="float-right btn btn-sm btn-primary"><i
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($storeItemData,['method' => 'POST','route'=>'store-item.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'service'] ) }}
                        {{ Form::hidden('id') }}
                        <div class="row">
                           <div class="form-group col-md-4">
                                {{ Form::label('name_ar', __('messages.name').' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                                {{ Form::text('name[ar]', $storeItemData->getTranslation('name', 'ar'), ['placeholder' => __('messages.name_in_arabic'), 'class' => 'form-control', 'required', 'title' => __('validation.alpha_spaces')]) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            
                            <div class="form-group col-md-4">
                                {{ Form::label('name_en', __('messages.name').' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                                {{ Form::text('name[en]', $storeItemData->getTranslation('name', 'en'), ['placeholder' => __('messages.name_in_english'), 'class' => 'form-control', 'required', 'title' => __('validation.alpha_spaces')]) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <br />
                                {{ Form::select('category_id', [optional($storeItemData->category)->id => optional($storeItemData->category)->name], optional($storeItemData->category)->id, [
                                            'class' => 'select2js form-group category',
                                            'required',
                                            'id' => 'category_id',
                                            'data-placeholder' => __('messages.select_name',[ 'select' => __('messages.category') ]),
                                            'data-ajax--url' => route('ajax-list', ['type' => 'store_category']),
                                        ]) }}
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <br />
                                {{ Form::select('provider_id', [ optional($storeItemData->providers)->id => optional($storeItemData->providers)->display_name ], optional($storeItemData->providers)->id, [
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label" for="store_item_attachment">{{ __('messages.image') }}
                                </label>
                                <div class="custom-file">
                                    <input type="file" name="store_item_attachment[]" class="custom-file-input"
                                ...
                                <div class="border-left-2">
                                    ...
                                    <div class="ml-2 my-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 pr-10 text-center galary file-gallary-{{$storeItemData->id}}"
                                                data-gallery=".file-gallary-{{$storeItemData->id}}"
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                {{ Form::textarea('description[ar]', $storeItemData->getTranslation('description', 'ar') ?? old('description[ar]'), ['class' => 'form-control textarea', 'rows' => 3, 'placeholder' => __('messages.description_in_arabic')]) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>

                            <div class="form-group col-md-12">
                                {{ Form::label('description', trans('messages.description'), ['class' => 'form-control-label']) }}
                                {{ Form::textarea('description[en]', $storeItemData->getTranslation('description', 'en') ?? old('description[ar]'), ['class' => 'form-control textarea', 'rows' => 3, 'placeholder' => __('messages.description_in_english')]) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                        
                            <div class="form-group col-md-3">
                                <div class="custom-control custom-switch">
                                    {{ Form::checkbox('is_featured', $storeItemData->is_featured, null, ['class' => 'custom-control-input', 'id' => 'is_featured' ]) }}
                            ...
                            <div class="form-group col-md-3">
                                <div class="custom-control custom-switch">
                                    {{ Form::checkbox('digital_service', $storeItemData->digital_service, null, ['class' => 'custom-control-input', 'id' => 'digital_service' ]) }}
                                    <label class="custom-control-label"
                            ...
                            <div class="form-group col-md-3" id="is_enable_advance">
                                <div class="custom-control custom-switch">
                                    {{ Form::checkbox('is_enable_advance_payment', $storeItemData->is_enable_advance_payment , null, ['class' => 'custom-control-input' , 'id' => 'is_enable_advance_payment' ]) }}
                                    <label class="custom-control-label"
    ...
    (function($) {
        ...
        $(document).ready(function() {
            var provider_id = "{{ isset($storeItemData->provider_id) ? $storeItemData->provider_id : '' }}";

            var category_id = "{{ isset($storeItemData->category_id) ? $storeItemData->category_id : '' }}";
            var subcategory_id =
                "{{ isset($storeItemData->subcategory_id) ? $storeItemData->subcategory_id : '' }}";
        ...
        function getSubCategory(category_id, subcategory_id = "") {
            ...
            var get_subcategory_list =
                "{{ route('ajax-list', [ 'type' => 'store_subcategory','category_id' =>'']) }}" + category_id;
